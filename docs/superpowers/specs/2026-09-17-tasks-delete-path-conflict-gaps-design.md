...
**Decision-Log:** zwei ADRs nach Implementation — **036** der Aufgaben-Schreibpfad bekommt den Schnitt des Kalenders (PR 1), **037** die zwei von ADR-031 offen gelassenen Löcher (PR 2 + PR 3). Getrennt, weil es zwei Verträge sind: einer über die Form einer Mutation, einer über das Vokabular des Konflikt-Vergleichs. Beide ergänzen [ADR-031](../../decision-log.md) (Conflict-Detection), lösen nichts ab
