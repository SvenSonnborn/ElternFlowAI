...
| `dash.meal.question`       | Was essen wir heute?                                                                                                           | What are we eating today?                                                                                |
| `dash.meal.openRecipe`     | Rezept öffnen                                                                                                                  | Open recipe                                                                                              |
| `dash.meal.toShopping`     | Zur Einkaufsliste                                                                                                              | Add to shopping list                                                                                     |
| `dash.meal.empty.title`    | Noch nichts geplant                                                                                                            | Nothing planned yet                                                                                      |
| `dash.meal.empty.sub`      | Für diese Mahlzeit steht noch nichts im Wochenplan.                                                                            | Nothing in this week's plan for this meal yet.                                                           |
| `dash.meal.empty.cta`      | Essen planen                                                                                                                   | Plan meals                                                                                               |
| `dash.tomorrow.empty`      | Für morgen ist nichts vorzubereiten.                                                                                           | Nothing to prep for tomorrow.                                                                            |
| `dash.tomorrow.more`       | +{count} weitere                                                                                                               | +{count} more                                                                                            |
| `dash.a11y.openChild`      | Profil von {name} öffnen                                                                                                       | Open {name}'s profile                                                                                    |
| `dash.a11y.openFamily`     | {name} · Familie öffnen                                                                                                        | Open the family view for {name}                                                                          |
| `dash.a11y.moreMembers`    | {count} weitere Familienmitglieder anzeigen                                                                                    | Show {count} more family members                                                                         |
| `dash.a11y.prepTask`       | Aufgabe öffnen: {title}                                                                                                        | Open task: {title}                                                                                       |
| `dash.a11y.prepEvent`      | Termin öffnen: {title}                                                                                                         | Open event: {title}                                                                                      |
| `dash.a11y.prepMore`       | {count} weitere Vorbereitungen anzeigen                                                                                        | Show {count} more items to prepare                                                                       |
