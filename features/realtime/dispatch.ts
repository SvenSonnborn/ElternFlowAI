/**
 * Die einzige Datei der Sync-Schicht, die weiß, welche Query-Keys eine
 * Feature-Tabelle bei einer Änderung veraltet. Nicht die einzige, die
 * überhaupt Features kennt — `useFamilyRealtime.ts` importiert
 * `@/features/auth` und `@/features/supabase`, aber für Auth-Session und
 * Client, nicht für Query-Keys.
 *
